...
HD_PWD='/home/mdomingu/FPGAPrototypingByVerilogExamples/2.9.1Gate_level_greater_than/2.9.1Gate_level_greater_than.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log physical_mapping.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source physical_mapping.tcl
